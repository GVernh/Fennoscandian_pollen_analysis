...
N3 <- ggplot(conN, aes(x=age))+
  ...
  theme(legend.position="none")+
  theme(plot.background = element_rect(color = "grey", size = 1))+
  labs(title="CONIFEROUS WOODLAND", x="years BP", y="relative pollen abundance (summed)")
...
N4 <- ggplot(decN, aes(x=age))+
  ...
  theme(legend.position="none")+
  theme(plot.background = element_rect(color = "grey", size = 1))+
  labs(title="DECIDUOUS WOODLAND", x="years BP", y="relative pollen abundance (summed)")
...
N5 <- ggplot(wetwN, aes(x=age))+
  ...
  theme(legend.position="none")+
  theme(plot.background = element_rect(color = "grey", size = 1))+
  labs(title="WET WOODLAND", x="years BP", y="relative pollen abundance (summed)")
...
N6 <- ggplot(wetmN, aes(x=age))+
  ...
  theme(legend.position="none")+
  theme(plot.background = element_rect(color = "grey", size = 1))+
  labs(title="WET MEADOW", x="years BP", y="relative pollen abundance (summed)")
...
N7 <- ggplot(pasN, aes(x=age))+
  ...
  theme(legend.position="none")+
  theme(plot.background = element_rect(color = "grey", size = 1))+
  labs(title="PASTURE", x="years BP", y="relative pollen abundance (summed)")
...
N8 <- ggplot(araN, aes(x=age))+
  ...
  theme(legend.position="none")+
  theme(plot.background = element_rect(color = "grey", size = 1))+
  labs(title="ARABLE LAND", x="years BP", y="relative pollen abundance (summed)")
...
N9 <- ggplot(heaN, aes(x=age))+
  ...
  theme(legend.position="none")+
  theme(plot.background = element_rect(color = "grey", size = 1))+
  labs(title="HEATH", x="years BP", y="relative pollen abundance (summed)")
...
MM8 <- ggplot(araMM, aes(x=age))+
  ...
  scale_x_reverse(breaks = c(9000,8000,7000, 6000,5000,4000, 3000,2000,1000))+
  geom_vline(aes(xintercept = 3200, color = "hotpink"), size=1) +
  labs(title="ARABLE LAND", y="relative pollen abundance (summed)") +
  theme(legend.position="none",
        plot.title = element_text(size = 12),
        plot.subtitle = element_text(size = 10),
        plot.background = element_rect(color = "grey", size = 1))
...
SW7 <- ggplot(pasSW, aes(x=age))+
  ...
  geom_vline(aes(xintercept = 6000, color = "hotpink"), size=1) +
  scale_x_reverse(breaks = c(9000,8000,7000, 6000,5000,4000, 3000,2000,1000))+
  labs(title="PASTURE", y="relative pollen abundance (summed)") +
  theme(legend.position="none",
        plot.title = element_text(size = 12),
        plot.subtitle = element_text(size=10),
        plot.background = element_rect(color = "grey", size = 1))
